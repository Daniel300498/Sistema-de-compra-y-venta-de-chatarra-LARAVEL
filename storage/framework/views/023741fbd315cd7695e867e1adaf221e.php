...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('consultas.index')); ?>">Consultas</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php echo Form::model($consulta, ['route'=>['consultas.update', $consulta->id], 'method'=>'PUT', 'class'=>'row g-3', 'enctype'=>"multipart/form-data"]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="date" name="fecha" id="fecha" class="form-control <?php echo e($errors->has('fecha') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('fecha', $consulta->fecha)); ?>">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <select name="medico_id" id="medico_id" class="form-control <?php echo e($errors->has('medico_id') ? 'is-invalid' : ''); ?>">
                                ...
                                <?php $__currentLoopData = $medicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($medico->id); ?>"<?php echo e(old('medico_id', $consulta->medico_id) == $medico->id ? 'selected' : ''); ?>> <?php echo e($medico->nombres); ?> <?php echo e($medico->ap_paterno); ?> <?php echo e($medico->ap_materno); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" name="motivo_consulta" id="motivo_consulta" class="form-control <?php echo e($errors->has('motivo_consulta') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('motivo_consulta', $consulta->motivo_consulta)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <textarea name="diagnostico" id="diagnostico" rows="4" class="form-control <?php echo e($errors->has('diagnostico') ? 'is-invalid' : ''); ?>"><?php echo e(old('diagnostico', $consulta->diagnostico)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="4" class="form-control <?php echo e($errors->has('observaciones') ? 'is-invalid' : ''); ?>"><?php echo e(old('observaciones', $consulta->observaciones)); ?></textarea>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-hover table-bordered table-sm" id="datos" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $__currentLoopData = $consultas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td class="text-center"><?php echo e($key + 1); ?></td>
                  <td class="text-center"><?php echo e(date('d/m/Y', strtotime($item->fecha))); ?></td>
                  <td class="text-center"><?php echo e($item->motivo_consulta); ?></td>
                  <td class="text-center"><?php echo e($item->diagnostico); ?></td>
                  <td class="text-center"><?php echo e($item->observaciones); ?></td>
                    ...
                    <div class="btn-group" role="group">
                      ...
                      <ul class="dropdown-menu">
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('consultas.edit')): ?>
                          <li><a class="dropdown-item" href="<?php echo e(route('consultas.edit', $item->uuid)); ?>">Modificar datos</a></li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('consultas.destroy')): ?>
                          <li>
                            <a class="dropdown-item" href="<?php echo e(route('consultas.destroy', $item->uuid)); ?>" onclick="return confirm('¿Está seguro que desea eliminar la consulta?');">
                              Eliminar Consulta
                            </a>
                          </li>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/consultas/edit.blade.php ENDPATH**/ ?>