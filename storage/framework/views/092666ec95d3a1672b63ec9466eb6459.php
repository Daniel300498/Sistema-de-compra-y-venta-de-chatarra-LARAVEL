      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('asignacion_turno_buscar_empleado')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                               ...
                               <?php echo e($e->cargo); ?>
                                 ...
                                 <td class="d-flex justify-content-center" >
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('declaraciones.create')): ?>
                                        <a href="<?php echo e(route('asignacion_turno.create',$e->id)); ?>" class="btn btn-warning" title="Ver / Registrar un DDJJ"><i class="bi bi-clock"></i></a>
                                    <?php endif; ?>
                                </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/asignacion_turno/consulta.blade.php ENDPATH**/ ?>