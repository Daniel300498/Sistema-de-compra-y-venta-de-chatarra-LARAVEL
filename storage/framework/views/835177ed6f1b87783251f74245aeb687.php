      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           <form action="<?php echo e(route('turnos.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <input id="empresa" type="text" class="form-control <?php echo e($errors->has('empresa') ? ' error' : ''); ?>" name="empresa" value="company.defualt" readonly >
              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    ...
                    <select name="unidad" class="form-control <?php echo e($errors->has('unidad') ? ' error' : ''); ?>" id="unidad">
                      ...
                      <option value="1" <?php echo e(old('unidad')==1 ? 'selected' : ''); ?> selected>Dia</option>
                      <option value="2" <?php echo e(old('unidad')==2 ? 'selected' : ''); ?>>Semana</option>
                      <option value="3" <?php echo e(old('unidad')==3 ? 'selected' : ''); ?>>Mes</option>
              ...
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <input id="ciclo" type="number" class="form-control <?php echo e($errors->has('ciclo') ? ' error' : ''); ?>" name="ciclo" value="<?php echo e(old('ciclo')); ?>" >
              ...
              <div class="col-lg-4">
                ...
                <select name="horario_id" id="horario_id" class="form-control <?php echo e($errors->has('horario_id') ? ' error' : ''); ?>">
                  ...
                  <?php $__currentLoopData = $horario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ho): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($ho->id); ?>" <?php echo e(old('horario_id') == $ho->id ? 'selected' :''); ?>><?php echo e($ho->nombre); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/turnos/create.blade.php ENDPATH**/ ?>