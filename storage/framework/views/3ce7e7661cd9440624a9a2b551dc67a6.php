...
<div class="pagetitle">
    ...
    <div class="d-flex flex-row align-items-center justify-content-between mr-5">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.create')): ?>
            <a href="<?php echo e(route('roles.create')); ?>" class="btn back-color-second" title="Crea un nuevo rol con sus permisos">+ Crear Nuevo</a>
        <?php endif; ?>
    </div>
 </div><!-- End Page Title -->
                ...
                <tbody>
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-wrap text-center"><h5><span class="badge bg-primary"><?php echo e($role->users_count); ?> Usuarios</span></h5></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/roles/index.blade.php ENDPATH**/ ?>