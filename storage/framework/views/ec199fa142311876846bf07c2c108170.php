...
<table style="width:100%;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th style="font-size: 10px; text-align:center; vertical-align: middle;"><?php echo e(\Carbon\Carbon::parse($info_empleado_object->fecha_registro)->format('d/m/Y')); ?></th>
        <th style="font-size: 10px; text-align:center; vertical-align: middle;"><?php echo e($info_empleado_object->tipo_id->descripcion); ?></th>
    ...
    </table ><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/documentoMemorandum/pdf/reporte_pdf.blade.php ENDPATH**/ ?>