      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <!--CONTENIDO -->
           <?php echo Form::open(['route'=>'camas.store', 'class'=>'row g-3', 'enctype'=>"multipart/form-data"]); ?>

                <?php echo $__env->make('camas._form',['texto' => 'Guardar','color'=>'primary'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/camas/create.blade.php ENDPATH**/ ?>