...
<div class="col-lg-6 mt-2">
    ...
    <select id="pais" class="form-control <?php echo e($errors->has('pais') ? ' error' : ''); ?>" name="pais" value="<?php echo e(old('pais',$proveedor->pais)); ?>"   onkeyup="javascript:this.value=this.value.toUpperCase();" onkeydown="return soloLetras(event);">
        ...
        <?php $__currentLoopData = $paises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pais): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($pais->descripcion); ?>" <?php echo e(old('pais',$proveedor->pais) == $pais->descripcion ? 'selected' : ''); ?>>
...
<div class="row mt-2">
    <div class="text-center">
     <button type="submit" class="btn btn-primary">Guardar</button>
       <a href="<?php echo e(route('proveedores.index')); ?>" class="btn btn-danger">Salir</a>          
    </div>
</div>

<script src="<?php echo e(asset('assets/js/forms/contactosVarios.js')); ?>" type="text/javascript"></script>
<?php /**PATH C:\laragon\www\chatarra\resources\views/proveedores/_form.blade.php ENDPATH**/ ?>