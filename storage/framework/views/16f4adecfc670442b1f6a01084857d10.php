...
<div class="col-lg-4 mt-1">
    ...
    <input type="text" name="contacto_telefono" id="contacto_telefono" class="form-control <?php echo e($errors->has('contacto_telefono') ? ' error' : ''); ?>" value="<?php echo e(old('contacto_telefono',$empleado->contacto_telefono)); ?>" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 9 ||
...
<div class="row mt-2">
    <div class="text-center">
        ...
        <a href="<?php echo e(route('empleados.index')); ?>" class="btn btn-danger" style="background-color: var(--first); border-color:var(--first);">Cancelar</a>
    </div>
</div><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/empleados/_form.blade.php ENDPATH**/ ?>