...
<div class="col-lg-12 mt-2">
    ...
    <div class="d-flex">
        <input type="text" name="requisito_minimo" id="requisito_minimo" class="form-control <?php echo e($errors->has('requisito_minimo') ? ' error' : ''); ?>" value="<?php echo e(old('requisito_minimo',count($empleado->cargo)>0 ? $empleado->cargo[0]->pivot['cargos.requisito_minimo'] : '')); ?>" onkeyup="javascript:this.value=this.value.toUpperCase();">
    </div>
</div>
...
<div class="col-lg-3 mt-2">
    ...
    <input type="text" name="nit" id="nit" class="form-control <?php echo e($errors->has('nit') ? ' error' : ''); ?>" value="<?php echo e(old('nit',$empleado->nit)); ?>" disabled onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 9 ||
...
</div><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/empleados/secciones/institucional.blade.php ENDPATH**/ ?>