                ...
                <table cellspacing="0" width="100%" id="datos" class="table table-hover table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($e->cargo[0]->nombre); ?></td>
                            ...
                            <td class="d-flex justify-content-center" >
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('licencias.create')): ?>
                                    <a href="<?php echo e(route('licencias.create',$e->id)); ?>" class="btn btn-warning" title="Registrar una Nueva licencia"><i class="bi bi-journal-plus"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
