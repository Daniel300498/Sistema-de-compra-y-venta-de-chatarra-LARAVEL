                        ...
                        <thead >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-wrap"><?php echo e($p->descripcion); ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('permisos.edit',$p->id)); ?>" class="btn btn-success btn-round">Editar</a>
                                        <a href="<?php echo e(route('permisos.destroy',$p->id)); ?>" class="btn btn-danger btn-round">Eliminar</a>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard\resources\views/permisos/index.blade.php ENDPATH**/ ?>