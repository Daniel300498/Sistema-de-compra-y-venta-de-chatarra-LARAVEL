...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Editar Orden de Salida</li>
      </ol>
    </nav>
 </div><!-- End Page Title -->
        ...
        <div class="card">
          <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <h5 class="card-title">Editar Orden de Salida</h5>
                </div>
                ...
                <!--CONTENIDO -->
                <?php echo Form::model($orden_salida,['route'=>['orden_salida.update',$orden_salida->id],'method'=>'PUT','class'=>'row g-3','enctype'=>"multipart/form-data"]); ?>

                    <?php echo $__env->make('orden_salida._form',['texto' => 'Actualizar','color'=>'primary'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/orden_salida/edit.blade.php ENDPATH**/ ?>