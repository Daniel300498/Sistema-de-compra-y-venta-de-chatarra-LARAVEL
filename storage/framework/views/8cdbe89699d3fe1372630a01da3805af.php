      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <form id="pdfForm" action="<?php echo e(route('lactancias.reporte_ver')); ?>" method="POST" enctype="multipart/form-data"  >
            ...
            <div class="row mb-3">   
              <div class="row"> 
                <div class="col-lg-6">
                  ...
                  <input id="fecha_desde"  type="date" class="form-control text-center" name="fecha_desde" value="<?php echo e(old('fecha_desde')); ?>" required >
                </div>
                
              <div class="col-lg-6" >
                <?php echo e(Form::label('reporte','Tipo Reporte' )); ?> <span class="text-danger">(*)</span>
            ...
            <div class="text-center mt-3">
              ...
              <a href="<?php echo e(route('lactancias.index')); ?>" class="btn btn-danger">Salir</a>
            </div>
         </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/lactancia/reporte.blade.php ENDPATH**/ ?>