            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-1">
                <a href="#" class="logo-login d-flex align-items-center w-auto">
                  <img src="<?php echo e(asset('assets/img/file5.png')); ?>" alt=""  width="220px"  height="160px">
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                <div class="card-body">
                    <div class="pt-7 pb-2">
                        ...
                        <p class="text-center small">Debe ingresar el correo electr&oacute;nico, usuario y contrase√±a para acceder al sistema.</p>
                    </div>
                    ...
                    <form class="row g-3 needs-validation"  method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="col-12">
                         ...
                         <div class="col-12">
                          ...
                          <div class="invalid-feedback">Ingrese su contraseè´–a!</div>
                          <?php endif; ?>
                        </div>
...
</html><?php /**PATH C:\laragon\www\sistema_rrhh\resources\views/auth/login.blade.php ENDPATH**/ ?>