      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('consulta.orden_salida')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                ...
                <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="d-flex justify-content-center" >
                            ...
                            <button class="btn btn-warning" title="Registrar una Nueva Orden de Salida" onclick="crearOrden('<?php echo e($e->uuid); ?>')"><i class="bi bi-plus-circle" ></i></button>
                            <?php endif; ?>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/orden_salida/consulta.blade.php ENDPATH**/ ?>