  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo e(route('home')); ?>" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">SISTEMA DE ADMINISTRACIÓN<br> DE PERSONAL <br>GADLP-SAP</span>
      </a>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              ...
              <span><?php if(auth()->user()->empleado_id != null): ?><?php echo e(auth()->user()->empleado->cargo[0]->nombre); ?><?php else: ?> <?php echo e(auth()->user()->rol[0]->name); ?> <?php endif; ?></span>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('users.show',auth()->user()->id)); ?>">
...
</html><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/layouts/app.blade.php ENDPATH**/ ?>