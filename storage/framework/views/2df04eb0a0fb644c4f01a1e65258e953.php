...
<?php $__env->startSection('titulo','Documentos Complementarios'); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($e->cargo->area_nombre); ?></td>
                                <td class="d-flex justify-content-center" >
                                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('complementarios.create')): ?>
                                  <a href="<?php echo e(route('complementarios.create',$e->empleado->uuid)); ?>" class="btn btn-warning" title="Ver / Registrar un Documento Complementario"><i class="bi-paperclip"></i></a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/complementarios/empleados.blade.php ENDPATH**/ ?>