...
<div class="margin-top" style="border-radius: 20px; border: solid 1px #000;">
    ...
    <table>
        <tr>
            <td style="width: 5%;"></td>
            <td style="width: 10%;"><img src="<?php echo e(asset('assets/img/escudoGobiernoAutonomo.png')); ?>" width="60px" alt="Image"/></td>
            <td style="width: 70%;">
            ...
            <td style="width: 10%;"><img src="<?php echo e(asset('assets/img/escudoCondor.png')); ?>" width="60px" alt="Image"/></td>
            <td style="width: 5%;"></td>
        </tr>
    </table>
    <br>
    ...
    <table style="font-size: 14px; font-weight: bold;">
        ...
        <tr>
            ...
            <td style="width: 20%;"><?php if($documentacion->fotocopia_certificado_nacimiento == 'si'): ?> SI <?php else: ?> NO <?php endif; ?></td>
        </tr>
        <tr>
            <td style="width: 10%;"></td>
    ...
    <table style="font-size: 14px; font-weight: bold;">
        ...
        <tr>
            ...
            <td style="width: 20%;"><?php if($documentacion->certificacion_prevencion_violencia =='si'): ?> SI <?php else: ?> NO <?php endif; ?></td>
        </tr>
    </table>
    <hr class="hr">
