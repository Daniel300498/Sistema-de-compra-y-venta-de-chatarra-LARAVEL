            ...
            <input type="hidden" name="empleado_id" id="empleado_id" value="<?php echo e($empleado->id); ?>">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <select name="tipo" class="form-control" required id="tipo" Onchange = "mostrar('num')">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/declaraciones/create.blade.php ENDPATH**/ ?>