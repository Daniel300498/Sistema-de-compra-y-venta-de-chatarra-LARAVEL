...
<?php $__env->startSection('titulo','Enfermedades'); ?>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('buscar_empleado_enfermedad')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('enfermedades.create')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('enfermedades.create',$e->uuid)); ?>">Adjuntar Documentaci&oacute;n</a></li>
                                    <?php endif; ?>
                                    <?php if($e->documento != null && $e->et_deleted == null): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('enfermedades.edit')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('enfermedades.edit',$e->et_uuid)); ?>">Modificar datos Documentaci&oacute;n</a></li>
                                    <?php endif; ?>
                                    <?php endif; ?>
                                </ul>
                              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/enfermedades/consulta.blade.php ENDPATH**/ ?>