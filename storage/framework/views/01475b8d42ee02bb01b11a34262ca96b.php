      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('buscar_empleado_documento_memorandum')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row mt-3">
                                ...
                                <?php echo e($cargo->nombre); ?>
                                 ...
                                 <td class="d-flex justify-content-center" >
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('memorandums.create')): ?>
                                        <a href="<?php echo e(route('documento_memorandum_create',$empleado->uuid)); ?>" class="btn btn-warning" title="Ver / Registrar un DDJJ"><i class="bi-paperclip"></i></a>
                                    <?php endif; ?>
                                </td>
                        </tr>
                </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/documentoMemorandum/consulta.blade.php ENDPATH**/ ?>