         ...
         <div class="modal-content">
            ...
            <form id="storeProfesion" role="form">
                <div class="modal-body">
                    <div class="col-12">
                        <label for="descripcion" class="col-control-label">Nombre de la carrera</label> <span class="text-danger">(*)</span>
...
</div><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/empleados/modals/_modal_profesion.blade.php ENDPATH**/ ?>