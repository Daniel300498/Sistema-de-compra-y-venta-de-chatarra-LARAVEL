...
unset($__errorArgs, $__bag); ?>" name="descripcion" id=descripcion value="<?php echo e(old('descripcion',$role->descripcion)); ?>">
                ...
                <div class="text-center">
                 <?php echo e(Form::submit('Guardar',['class'=>'btn back-color-second btn-round'])); ?>

                 <a href="<?php echo e(route('roles.index')); ?>" class="btn back-color-first btn-round">Cancelar</a>
             </div>
           </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/roles/_form.blade.php ENDPATH**/ ?>