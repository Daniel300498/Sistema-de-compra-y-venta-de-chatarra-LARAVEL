    ...
    <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
        ...
        <tr>
            <th colspan="6" style="text-align: center; font-size: 16px; font-weight: bold; border: 1px solid black; vertical-align: middle; white-space: nowrap;">
                <?php if($area_trabajo): ?>
                CORRESPONDIENTE AL ÁREA DE: <?php echo e($area_trabajo); ?>
        ...
        <tbody>
                ...
                <tr>
                    <td></td>
                    <td style="border: 1px solid black;"><?php echo e($registro->empleado->ap_paterno); ?> <?php echo e($registro->empleado->ap_materno); ?> <?php echo e($registro->empleado->nombres); ?> </td>
                    <td style="border: 1px solid black;"><?php echo e($registro->empleado->ci); ?> <?php echo e($registro->empleado->ci_complemento); ?> <?php echo e($registro->empleado->ci_lugar); ?></td>
                    <td style="border: 1px solid black; padding: 8px; text-align: center; vertical-align: middle; white-space: normal; word-wrap: break-word;">
                        <?php echo e($registro->cargo->nombre); ?>

                    </td>

                    <?php if($registro->empleado->documentacion->certificado_aymara): ?>
                    <td style="border: 1px solid black;">SI</td>
                    <td style="border: 1px solid black; padding:8px; text-align: center; vertical-align: middle; white-space: normal; word-wrap: break-word"><?php echo e($registro->empleado->documentacion->emitido_por); ?></td>
                     <?php else: ?>
...
<?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/documentacion/reporte_excel.blade.php ENDPATH**/ ?>