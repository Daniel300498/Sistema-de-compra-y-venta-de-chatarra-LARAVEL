    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <p>Desde esta sección puede modificar y eliminar el horario correspondiente
            ...
            <table class="table table-hover table-bordered table-sm" cellspacing="0" width="100%" id="datos">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Salida Turno</th>
              ...
              <tbody>
                <?php $__currentLoopData = $turnos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <?php echo e($document->entrada_turno); ?>

                    </td>
                    <td class="text-center">
                        <?php echo e($document->salida_turno); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/horarios/index.blade.php ENDPATH**/ ?>