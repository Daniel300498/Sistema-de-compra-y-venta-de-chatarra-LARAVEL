     ...
     <div class="d-flex flex-row align-items-center justify-content-between">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('consultas.index')); ?>">Consultas M&eacute;dica</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('buscar_pacientes')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                            ...
                            <?php $__currentLoopData = $pacientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center" >
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('consultas.create')): ?>
                                            <a href="<?php echo e(route('consultas.create',$e->uuid)); ?>" class="btn btn-warning" title="Ver / Registrar"><i class="bi-paperclip"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/consultas/consulta.blade.php ENDPATH**/ ?>