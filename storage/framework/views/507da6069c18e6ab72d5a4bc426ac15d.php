...
<div class="col-lg-6 mt-2">
    ...
    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#profesion" title="Agregar Institución">
        <i class="bi bi-plus-lg"></i>
      </button>
...
<div class="col-lg-6 mt-2 ">
    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#institutos" title="Agregar Institución">
            <i class="bi bi-plus-lg"></i>
          </button>
...
<div class="col-lg-6">
    <?php echo e(Form::label('ultimo_empleo','&Uacute;ltimo Empleo' )); ?> <span class="text-danger">(*)</span>
    ...
    <?php if($errors->has('ultimo_empleo')): ?>
        <span class="text-danger">
            <?php echo e($errors->first('ultimo_empleo')); ?>

        </span>
    <?php endif; ?>
</div><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/pacientes/secciones/ocupacion.blade.php ENDPATH**/ ?>