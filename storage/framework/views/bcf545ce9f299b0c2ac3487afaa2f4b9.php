                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center" >
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('licencias.create')): ?>
                                    <a href="<?php echo e(route('licencias.create',$e->id)); ?>" class="btn btn-warning" title="Registrar una Nueva licencia"><i class="bi bi-pencil-square"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/licencias/empleados.blade.php ENDPATH**/ ?>