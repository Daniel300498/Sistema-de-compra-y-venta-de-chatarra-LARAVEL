        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title">Editar Memorandum</h5>
            ...
            <?php echo Form::model($memorandums,['route'=>['memorandums.updated',$memorandums->id],'method'=>'PUT','class'=>'row g-3','enctype'=>"multipart/form-data"]); ?>

              <?php echo csrf_field(); ?>
              <input type="hidden" name="memorandums_id" id="memorandums_id" value="<?php echo e($memorandums->id); ?>" >
              <div class="row mb-3">
                  <div class="col-lg-3">
                    <?php echo e(Form::label('fecha_emision','Fecha De Emision')); ?> <span class="text-danger">(*)</span>
                        <input id="fecha_emision" type="date" class="form-control <?php echo e($errors->has('fecha_emision') ? ' error' : ''); ?>" name="fecha_emision" value="<?php echo e($memorandums->fecha_emision); ?>"   >
                  ...
                  <div class="col-lg-3">
                    ...
                    <select name="tipo" id="tipo" class="form-control <?php echo e($errors->has('tipo') ? ' error' : ''); ?>"  id="tipo" Onchange = "mostrar()" data-old="<?php echo e(old('tipo')); ?>">
                      ...
                      <?php $__currentLoopData = $tipos_memorandum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tipo->id); ?>" <?php echo e(old('tipo',$memorandums->memorandum_tipo_id)== $tipo->id? 'selected' :''); ?>><?php echo e($tipo->descripcion); ?></option> 
                  ...
                  <?php if($memorandums->memorandum_tipo_id==6): ?>
                  <div class="col-lg-3" >
                    <label for="todos_empleados" >Generado Por<span class="text-danger">(*)</span></label>
                    <select name="todos_empleados"  class="form-control form-control <?php echo e($errors->has('todos_empleados') ? ' error' : ''); ?>" id="tipo_empleados" >
                      <option value="">--SELECCIONE--</option>
                      <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($e->id); ?>" <?php echo e(old('todos_empleados',$memorandums->emitido_por) == $e->id ? 'selected' :''); ?> ><?php echo e($e->nombres); ?> <?php echo e($e->ap_paterno); ?> <?php echo e($e->ap_materno); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                  <?php endif; ?>
                ...
                <div class="col-lg-8">
                  ...
                  <select name="cargo_id" id="cargo_id" class="form-control <?php echo e($errors->has('cargo_id') ? ' error' : ''); ?>">
                    ...
                    <?php $__currentLoopData = $cargos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ca->id); ?>" <?php echo e(old('cargo_id',$memorandums->cargo_id) == $ca->id ? 'selected' :''); ?>><?php echo e($ca->nro_item); ?> - <?php echo e($ca->nombre); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
              ...
              <div class="row">
                <div class="col-lg-12">
                    <label for="cargo_id">Contenido Memorandum <span class="text-danger">(*)</span></label>
                    <textarea name="contenido" id="contenido" cols="100" rows="7" ><?php echo e($memorandums->contenido); ?></textarea>
              ...
              <div class="text-center mt-3">
                  ...
                  <a href="<?php echo e(route('memorandums.create',$empleado->id)); ?>" class="btn btn-danger">Salir</a>
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/memorandums/edit.blade.php ENDPATH**/ ?>