            ...
            <div class="tab-content pt-2">
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8"><?php if($user->empleado_id != null): ?><?php echo e($user->empleado->cargo[0]->area->nombre); ?> <?php endif; ?></div>
                </div>
                ...
                <div class="row">
                 ...
                 <?php if($user->empleado): ?>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label">Correo Electr&oacute;nico</div>
                  <div class="col-lg-9 col-md-8"><?php echo e($user->empleado->email); ?></div>
                </div>
                <?php endif; ?> 
              </div>
              ...
              <div class="tab-pane fade pt-3" id="profile-change-password">
                <form method="POST" action="<?php echo e(route('change.password')); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="row mb-3">
                    <label for="current_password" class="col-md-4 col-lg-3 col-form-label <?php echo e($errors->has('current_password') ? ' error' : ''); ?>">Contraseña Actual</label>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="row mb-3">
                  <label for="new_password" class="col-md-4 col-lg-3 col-form-label <?php echo e($errors->has('new_password') ? ' error' : ''); ?>">Nueva Contraseña</label>
                  <div class="col-md-8 col-lg-6 position-relative">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/users/profile.blade.php ENDPATH**/ ?>