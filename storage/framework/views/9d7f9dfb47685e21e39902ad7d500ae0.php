                        ...
                        <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-center" >
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('años_servicio.create')): ?>
                                        <a href="<?php echo e(route('años_servicio.create',$e->id)); ?>" class="btn btn-warning" title="Ver / Registrar Años de servicio"><i class="bi bi-cloud-upload"></i></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/kardex/años_servicio/empleados.blade.php ENDPATH**/ ?>