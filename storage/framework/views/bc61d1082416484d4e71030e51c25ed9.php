...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>">Nuevo</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <?php echo Form::open(['route'=>['discapacidades.store',$empleado->id],'class'=>'row g-3','enctype'=>"multipart/form-data"]); ?>

                <?php echo $__env->make('discapacidad._form',['texto' => 'Guardar','tipo'=>'1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
