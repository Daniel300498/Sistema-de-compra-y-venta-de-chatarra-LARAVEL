          ...
          <div class="card-body">
           ...
           <form action="<?php echo e(route('años_servicio.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center mt-3">
                ...
                <a href="<?php echo e(route('años_servicio.index')); ?>" class="btn btn-warning">Salir</a>
            </div>
         </form>
         <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gobernacion\sistema_rrhh\resources\views/kardex/años_servicio/create.blade.php ENDPATH**/ ?>