        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="row g-3">
                ...
                <div class="row mt-2">
                    <div class="col-lg-4">
                        ...
                        <input type="date" name="fecha_registro" id="fecha_registro" class="form-control <?php echo e($errors->has('fecha_registro') ? ' error' : ''); ?>" value="<?php echo e(old('fecha_registro',$empleado->fecha_registro)); ?>" readonly>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $lactancias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lactancia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php if($lactancia->fecha_inicio_prenatal != null): ?> PRENATAL <?php else: ?> POSTNATAL <?php endif; ?></td>
                        <td><?php if($lactancia->fecha_inicio_prenatal != null): ?> <a href="<?php echo e(asset('documentos_lactancia/'.$lactancia->documento_prenatal)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a> <?php else: ?> <a href="<?php echo e(asset('documentos_lactancia/'.$lactancia->documento_postnatal)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a> <?php endif; ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </table>
            <?php else: ?>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $enfermedad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e(date('d-m-Y',strtotime($e->fecha_inicio_enfermedad))); ?></td>
                        <td><?php echo e($e->descripcion); ?></td>
                        <td>
                            <a href="<?php echo e(asset('documento_enfermedad_terminal_/'.$e->documento)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $cash; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e(date('d-m-Y',strtotime($c->created_at))); ?></td>
                        <td>
                            <a href="<?php echo e(asset('documentos_empleados/años_servicio/'.$c->archivo)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $vacaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e(date('d/m/Y',strtotime($v->fecha_solicitud))); ?></td>
                        <td class="text-center"><?php echo e(date('d/m/Y',strtotime($v->fecha_inicio))); ?></td>
                        <td class="text-center"><?php echo e(date('d/m/Y',strtotime($v->fecha_fin))); ?></td>
                        <td class="text-center"><?php echo e($v->estado); ?></td>
            ...
            <?php if(count($otrosDocumentos)>0): ?>
            <table class="table table-bordered">
                <tr>
                    <th class="text-center">Descripcion</th>
                    <th class="text-center"></th>
                </tr>
                <?php $__currentLoopData = $otrosDocumentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($v->descripcion); ?></td>
                        <td class="text-center"><a href="<?php echo e(asset('documentos_complementarios/'.$v->nombre)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a></td>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $licencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($v->descripcion); ?></td>
                        <td class="text-center"><a href="<?php echo e(asset('documentos_complementarios/'.$v->nombre)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a></td>
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $comisiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $co): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e(date('d/m/Y',strtotime($co->fecha_inicio))); ?></td>
                        <td class="text-center"><?php echo e(date('d/m/Y',strtotime($co->fecha_fin))); ?></td>
                        <td class="text-center"><?php if($co->informe!=null): ?><a href="<?php echo e(asset('comisiones_actividades_desarrolladas/'.$co->informe)); ?>" target="_blank"> <button class="btn btn-success btn-sm" title="Ver documento">Ver Archivo</button></a><?php endif; ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/kardex/archivo_digital/archivo.blade.php ENDPATH**/ ?>