...
<div class="row mb-1">
    ...
    <div class="col-md-6">
        <input id="email" type="text" class="form-control<?php echo e($errors->has('email') ? ' error' : ''); ?>" name="email" value="<?php echo e(old('email', isset($user) ? $user->email : '')); ?>">
...
</form><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/users/_form.blade.php ENDPATH**/ ?>