...
<div class="row mb-1">
    ...
    <div class="col-md-6 mb-0 pb-0">
        <select name="grupo"  class="form-control form-control <?php echo e($errors->has('role_id') ? ' error' : ''); ?>" id="role_id" onchange="changeRol(this)">
            <option value="">--SELECCIONE--</option>
            <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($grupo->id); ?>" <?php echo e(old('grupo',$permiso->grupo ? $permiso->grupo :'')== $grupo->id ? 'selected' : ''); ?>><?php echo e($grupo->name); ?> <em><?php echo e($grupo->descripcion); ?></em></option>
...
</form><?php /**PATH C:\laragon\www\dashboard\resources\views/permisos/_form.blade.php ENDPATH**/ ?>