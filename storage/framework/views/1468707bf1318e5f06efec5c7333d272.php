...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('tiempo_descanso.create')); ?>">Tiempo Descanso</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           <form id="tiempoDescansoForm" action="<?php echo e(route('tiempo_descanso.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>



            <div class="row">
              <input id="empresa" type="hidden" class="form-control <?php echo e($errors->has('empresa') ? ' error' : ''); ?>" name="empresa" value="company.default" readonly >
              <div class="col-lg-2">
              </div>
              <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                ...
                <select name="tipo_calculo" class="form-control <?php echo e($errors->has('tipo_calculo') ? ' error' : ''); ?>" id="tipo_calculo">
                  ...
                  <option value="1" <?php echo e(old('tipo_calculo')==1 ? 'selected' : ''); ?> selected>Auto Descontar</option>
                  <option value="2" <?php echo e(old('tipo_calculo')==2 ? 'selected' : ''); ?>>Requiere Marcaci&oacute;n</option>
                </select>
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <input id="hora_inicial" type="time" class="form-control <?php echo e($errors->has('hora_inicial') ? ' error' : ''); ?>" name="hora_inicial" value="<?php echo e(old('hora_inicial')); ?>" >
                ...
                <div class="col-lg-4">
                  ...
                  <input id="hora_final" type="time" class="form-control <?php echo e($errors->has('hora_final') ? ' error' : ''); ?>" name="hora_final" value="<?php echo e(old('hora_final')); ?>" >
                ...
                <div class="col-lg-4">
                  ...
                  <input id="duracion_descanso" type="number" class="form-control<?php echo e($errors->has('duracion_descanso') ? ' error' : ''); ?>" name="duracion_descanso" value="<?php echo e(old('duracion_descanso')); ?>" >
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <select name="estado_marcacion" class="form-control <?php echo e($errors->has('estado_marcacion') ? ' error' : ''); ?>" id="estado_marcacion">
                    ...
                    <option value="1" <?php echo e(old('estado_marcacion')==1 ? 'selected' : ''); ?> selected>No</option>
                    <option value="2" <?php echo e(old('estado_marcacion')==2 ? 'selected' : ''); ?>>Si</option>
                  </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/tiempo_descanso/create.blade.php ENDPATH**/ ?>