...
<?php echo $__env->make('medicos.secciones.datos_personales', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="row mt-2">
    <div class="text-center">
        ...
        <a href="<?php echo e(route('medicos.index')); ?>" class="btn btn-danger" style="background-color: var(--first); border-color:var(--first);">Cancelar</a>
    </div>
</div><?php /**PATH C:\laragon\www\integrado\clinica_irca\resources\views/medicos/_form.blade.php ENDPATH**/ ?>