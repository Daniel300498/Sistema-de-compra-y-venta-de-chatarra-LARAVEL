...
<body>
    ...
    <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
        ...
        <tr>
                        ...
                        <th bgcolor="#e5b8b7" style="width:99px; border: 1px solid black; font-weight: bold; text-align: center;">LUGAR TRABAJO</th>
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td style="border: 1px solid black;"><?php echo e($registro->parametro_descripcion); ?></td>
                    ...
                    <td style="border: 1px solid black;">Bs. <?php echo e($monto_pago->valor); ?></td>
                    <td style="border: 1px solid black;">Bs. <?php echo e(number_format($registro->dias_trabajados * $monto_pago->valor, 2)); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<?php /**PATH /home4/gadlprrhh/public_html/sistema_rrhh/resources/views/refrigerios/pdf/refrigerio_excel.blade.php ENDPATH**/ ?>