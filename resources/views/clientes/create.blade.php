...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb"> 
        ...
        <li class="breadcrumb-item"><a href="{{ route('clientes.create') }}">Registro de Cliente</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           {!! Form::open(['route'=>'clientes.store','class'=>'row g-3','enctype'=>"multipart/form-data"]) !!}
                @include('clientes._form',['texto' => 'Registrar','color'=>'primary'])
            {!! Form::close() !!}
