...
@section('titulo','Tiempo Descanso')
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           <form id="tiempoDescansoForm" action="{{route('tiempo_descanso.update')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field()}}
            <input type="hidden" name="id" id="id" value="{{$tiempodescanso->id }}">


            <div class="row">
              <input id="empresa" type="hidden" class="form-control {{ $errors->has('empresa') ? ' error' : '' }}" name="empresa" value="{{$tiempodescanso->empresa}}" readonly >
                
              <div class="col-lg-4">
                {{Form::label('nombre','Nombre' )}} <span class="text-danger">(*)</span>
                <input id="nombre" type="text" class="form-control {{ $errors->has('nombre') ? ' error' : '' }}" name="nombre" value="{{$tiempodescanso->nombre}}" >
               ...
               <div class="col-lg-4">
                ...
                <select name="tipo_calculo" class="form-control {{ $errors->has('tipo_calculo') ? ' error' : '' }}" id="tipo_calculo">
                    ...
                    <option value="1" {{ old('tipo_calculo',$tiempodescanso->tipo_calculo ) =='1' ? 'selected' :'' }}>Auto Descontar</option>
                    <option value="2" {{ old('tipo_calculo',$tiempodescanso->tipo_calculo ) =='2' ? 'selected' :'' }}>Requiere Marcaci&oacute;n</option>
                </select>
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <input id="hora_inicial" type="time" class="form-control {{ $errors->has('hora_inicial') ? ' error' : '' }}" name="hora_inicial" value="{{$tiempodescanso->hora_inicial}}" >
                ...
                <div class="col-lg-4">
                  ...
                  <input id="hora_final" type="time" class="form-control {{ $errors->has('hora_final') ? ' error' : '' }}" name="hora_final" value="{{$tiempodescanso->hora_final}}" >
                ...
                <div class="col-lg-4">
                  ...
                  <input id="duracion_descanso" type="number" class="form-control{{ $errors->has('duracion_descanso') ? ' error' : '' }}" name="duracion_descanso" value="{{$tiempodescanso->duracion_descanso}}" >
              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                  ...
                  <select name="estado_marcacion" class="form-control {{ $errors->has('estado_marcacion') ? ' error' : '' }}" id="estado_marcacion">
                    <option value="" selected>-- SELECCIONE --</option>
                    <option value="1" {{ old('estado_marcacion',$tiempodescanso->estado_marcacion ) =='1' ? 'selected' :'' }}>No</option>
                    <option value="2" {{ old('estado_marcacion',$tiempodescanso->estado_marcacion ) =='2' ? 'selected' :'' }}>Si</option>
