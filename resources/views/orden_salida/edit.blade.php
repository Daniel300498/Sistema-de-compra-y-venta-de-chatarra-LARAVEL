      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
                ...
                <!--CONTENIDO -->
                {!! Form::model($orden_salida,['route'=>['orden_salida.update',$orden_salida->id],'method'=>'PUT','class'=>'row g-3','enctype'=>"multipart/form-data"]) !!}
                    @include('orden_salida._form',['texto' => 'Actualizar','color'=>'primary'])
                {!! Form::close() !!}
