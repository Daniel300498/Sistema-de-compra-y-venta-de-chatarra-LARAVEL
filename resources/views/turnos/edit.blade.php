      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
           ...
           <!--CONTENIDO -->
           <form action="{{route('turnos.update')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field()}}
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <input id="empresa" type="text" class="form-control {{ $errors->has('empresa') ? ' error' : '' }}" name="empresa" value="{{$turno->empresa}}" readonly >
              ...
              <div class="col-lg-4">
                ...
                <input id="nombre" type="text" class="form-control {{ $errors->has('nombre') ? ' error' : '' }}" name="nombre" value="{{$turno->nombre}}" >
                ...
                <div class="col-lg-4">
                    ...
                    <option value="1" {{ old('unidad',$turno->unidad ) =='1' ? 'selected' :'' }}>Dia</option>
                    <option value="2" {{ old('unidad',$turno->unidad ) =='2' ? 'selected' :'' }}>Semana</option>
                    <option value="3" {{ old('unidad',$turno->unidad ) =='3' ? 'selected' :'' }}>Mes</option>
                    </select>
              ...
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <input id="ciclo" type="number" class="form-control {{ $errors->has('ciclo') ? ' error' : '' }}" name="ciclo" value="{{$turno->ciclo}}" >
                  @if ($errors->has('ciclo'))
                      <span class="text-danger">
                          {{ $errors->first('ciclo') }}
                      </span>
              ...
              <div class="col-lg-4">
                ...
                <select name="horario_id" id="horario_id" class="form-control {{ $errors->has('horario_id') ? ' error' : '' }}">
                  ...
                  @foreach ($horario as $ho)
                      <option value="{{$ho->id}}" {{ old('horario_id',$turno->horario_id) == $ho->id ? 'selected' :'' }}>{{$ho->nombre}}</option>
                  @endforeach
