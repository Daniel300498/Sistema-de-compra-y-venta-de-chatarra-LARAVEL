     ...
     <div class="d-flex flex-row align-items-center justify-content-between">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('internaciones.index') }}">Internaciones</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{route('buscar_pacientes_internacion')}}" method="post">
                @csrf
                <div class="row">
                            ...
                            @foreach($pacientes as $e)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center" >
                                        @can('internaciones.create')
                                            <a href="{{route('internaciones.create',$e->uuid)}}" class="btn btn-warning" title="Ver / Registrar"><i class="bi-paperclip"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
