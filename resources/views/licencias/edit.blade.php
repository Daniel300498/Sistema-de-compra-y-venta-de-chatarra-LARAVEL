...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item"><a href="{{ route('licencias.index') }}">Ver Registrados</a></li>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
                ...
                <!--CONTENIDO -->
                {!! Form::model($licencia,['route'=>['licencias.update',$licencia->id,$licencia->estado_id],'method'=>'PUT','class'=>'row g-3','enctype'=>"multipart/form-data"]) !!}
                    @include('licencias._form',['texto' => 'Actualizar','color'=>'primary'])
                {!! Form::close() !!}
