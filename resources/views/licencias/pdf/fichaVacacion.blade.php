...
<link rel="stylesheet" type="text/css" href="{{url('/assets/css/licencias/pdf_licencia_vac.css')}}">
         ...
         <table class="title">
            <tr class="items">
                  <td style="width: 10%; text-align:center">
                     <img src="{{asset('assets/img/escudoGobiernoAutonomo.png')}}" width="70px" alt="Image"/>
