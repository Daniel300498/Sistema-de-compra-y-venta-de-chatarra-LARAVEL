      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{route('consulta.licencia')}}" method="post">
                @csrf
                <div class="row">
                ...
                @foreach($empleados as $e)
                    <tr>
                        ...
                        <td class="d-flex justify-content-center" >
                            ...
                            <a href="{{route('licencias.create',$e->uuid)}}" class="btn btn-warning" title="Registrar una Nueva licencia"><i class="bi bi-plus-circle"></i></a>
                            @endcan
                        </td>
                    </tr>
                @endforeach
