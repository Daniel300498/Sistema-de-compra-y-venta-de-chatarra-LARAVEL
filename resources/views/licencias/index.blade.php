    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
         ...
         <input type="hidden" value="{{ auth()->user()->can('licencias.edit') }}" id='can_edit'>
         <input type="hidden" value="{{ auth()->user()->can('licencias.show') }}" id='can_show'>
         <input type="hidden" value="{{ auth()->user()->can('licencias.upload') }}" id='can_upload'>
         <input type="hidden" value="{{ auth()->user()->can('licencias.destroy') }}" id='can_destroy'>
         <input type="hidden" value="{{ auth()->user()->can('licencias.edit_rrhh') }}" id='can_edit_rrhh'>
         <input type="hidden" value="{{ auth()->user()->can('licencias.edit_jefe') }}" id='can_edit_jefe'>
...
<script src="{{ asset('assets/js/forms/licenciaIndex.js') }}" type="text/javascript"></script>
