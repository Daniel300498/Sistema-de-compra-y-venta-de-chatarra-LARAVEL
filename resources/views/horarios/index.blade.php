              ...
              <tbody>
                @foreach ($turnos as  $key=>$document)
                  <tr>
                    ...
                    <td class="text-center">
                      {{ $document->entrada_turno}}
                    </td>
                    <td class="text-center">
                        {{ $document->salida_turno}}
                    </td>
                    <td class="text-center">
                      <a href="{{route('horarios.edit',$document->id )}}" class="btn btn-warning" title="Modificar datos"><i class="bi bi-pencil-square"></i></a>
                    </td>
