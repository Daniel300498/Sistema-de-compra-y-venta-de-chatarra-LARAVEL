        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title">Modificar datos del documento de Enfermedad Terminal</h5>
             ...
             <p>Debe rellenar todos los campos marcados con <strong class="text-danger">(*)</strong>.</p>
              <!--CONTENIDO -->
              {!! Form::model($empleado,['route'=>['enfermedades.update',[$enfermedadTerminal, $empleado]],'method'=>'PUT','class'=>'row g-3','enctype'=>"multipart/form-data"]) !!}
                  @include('enfermedades._form',['texto' => 'Actualizar','color'=>'primary'])
              {!! Form::close() !!}
