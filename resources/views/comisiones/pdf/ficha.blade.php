<link rel="stylesheet" type="text/css" href="{{url('/assets/css/comisiones/pdf_comision.css')}}">
      ...
      <div style="padding: 12px">
         ...
         <table class="body">
            <tr class="items">
                     ...
                     <td style="width: 35%; text-align:center" >
                        <fieldset class='float-label-field'>
                           <input id="txtName" type='text' value="{{$comision->fecha_inicio}}">
                        </fieldset>
                     </td>
                     <td style="width: 15%;" >
                        <fieldset class='float-label-field'>
                     ...
                     <td style="width: 35%; text-align:center" >
                        <fieldset class='float-label-field'>
                           <input id="txtName" type='text' value="{{$comision->fecha_fin}}">
                        </fieldset>
                     </td>
            </tr>      
         </table>
         ...
         <table class="body">
            <tr class="items">
                ...
                <td style="width: 70%; text-align:center" >
                   <fieldset class='float-label-field'>
                      <input id="txtName" type='text' value="{{$cargo->nombre}}">
                   </fieldset>
                </td>
            </tr>
         </table>
         ...
         <table class="body">
            <tr class="items">
                ...
                <td style="width: 70%; text-align:center" >
                   <fieldset class='float-label-field'>
                      <input id="txtName" type='text' value="{{$tipo1}}">
                   </fieldset>
                </td>
            </tr>
         </table>
         ...
         <table class="body">
            <tr class="items">
                ...
                <td style="width: 70%; text-align:center" >
                   <fieldset class='float-label-field'>
                      <input id="txtName" type='text' value="{{$tipo}}">
                   </fieldset>
                </td>
            </tr>
         </table>
         ...
         <table class="body">
            <tr class="items">
                ...
                <td style="width: 70%; text-align:center" >
                   <fieldset class='float-label-field'>
                      <input id="txtName" type='text' value="{{$comision->hora_entrada}}">
                   </fieldset>
                </td>
            </tr>
         </table>
         ...
         <table class="body">
            <tr class="items">
                ...
                <td style="width: 70%; text-align:center" >
                   <fieldset class='float-label-field'>
                      <input id="txtName" type='text' value="{{$comision->hora_salida}}">
                   </fieldset>
                </td>
            </tr>
         </table>
