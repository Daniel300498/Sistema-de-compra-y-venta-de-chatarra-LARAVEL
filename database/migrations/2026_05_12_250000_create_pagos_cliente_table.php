...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pagos_cliente', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('cuenta_origen_id')->nullable(); // cuenta del cliente
            $table->foreign('cuenta_origen_id')->references('id')->on('cuentas_bancarias');
            $table->unsignedBigInteger('cuenta_destino_id')->nullable(); // cuenta de la empresa (empleado)
